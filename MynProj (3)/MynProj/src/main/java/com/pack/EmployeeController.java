...
public class EmployeeController {
	...
	public String add2(Model m) {
	 ...
	 @RequestMapping("/addReg3") public ModelAndView userInfo(Employee
			 emp	 ) { ModelMap model=new ModelMap();
	 ...
	 @RequestMapping("/addReg6")
		public String add6(Model m) {
			m.addAttribute("emp", new Employee());
			return "Reject";
		}
	
	 @RequestMapping("/login")
		public String add7(Model m) {
			m.addAttribute("emp", new Employee());
			return "user";
		}
	
	 @RequestMapping("/addReg7")
		public String add8(Model m) {
			m.addAttribute("emp", new Employee());
			return "registration";
		}
	 ...
	 @RequestMapping("/addReg8")
	 public String viewemp3(Model m) {
			List<Employee> list = employeeDao.viewAll();
			m.addAttribute("list", list);
			return "Pending1";
		}
	 @RequestMapping("/addReg9")
	 public String viewemp4(Model m) {
			List<Employee> list = employeeDao.viewAll();
			m.addAttribute("list", list);
			return "Homepage";
		}
		 ...
		 */
			  ...
			  @RequestMapping("/addReg5") 
			  public String add5(Model m) {
			  m.addAttribute("emp", new Employee());
			  return "Authorize"; }
			 
			  @RequestMapping("/addReg10") 
			  public String add9(Model m) {
			  m.addAttribute("emp", new Employee());
			  return "Pending2"; }
